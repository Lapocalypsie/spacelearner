...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-8", className, "w-full bg-white")}
      classNames={{
        months: "flex flex-col shadow-lg rounded-lg p-4 sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0",
        month: "space-y-4 rounded-lg",
        caption: "flex justify-center pt-1 relative items-center pt-4",
